...
ThingDevice redButton(&adapter, "Moz It Button Red", "IoT-Bus 433Mhz Moz It Red button", sensorTypes);
ThingProperty buttonProperty1(&redButton, "Button", "433Mhz Red Button 1", BOOLEAN, "BooleanProperty");

// keyring with single button
const char* sensorTypes2[] = {"binarySensor", nullptr};
ThingDevice keyButton(&adapter, "Moz It Button Keyring", "IoT-Bus 433Mhz Moz It Power Button", sensorTypes2);
ThingProperty buttonProperty2(&keyButton, "Power", "433Mhz Power", BOOLEAN, "BooleanProperty");

// keyring with two buttons
const char* sensorTypes3[] = {"binarySensor", nullptr};
ThingDevice keyButton2(&adapter, "Moz It Two Buttons", "IoT-Bus 433Mhz Moz It Two Buttons", sensorTypes3);
ThingProperty buttonProperty3(&keyButton2, "Button A", "433Mhz Key Button A", BOOLEAN, "BooleanProperty");
ThingProperty buttonProperty4(&keyButton2, "Button B", "433Mhz Key Button B", BOOLEAN, "BooleanProperty");
...
ThingDevice lightController(&adapter, "LightController", "IoT-Bus 433Mhz Light Controller", sensorTypes);
ThingProperty control1(&lightController, "Control 1", "433Mhz Light Control 1", BOOLEAN, "BooleanProperty");
ThingProperty control2(&lightController, "Control 2", "433Mhz Light Control 2", BOOLEAN, "BooleanProperty");
ThingProperty control3(&lightController, "Control 3", "433Mhz Light Control 3", BOOLEAN, "BooleanProperty");
ThingProperty control4(&lightController, "Control 4", "433Mhz Light Control 4", BOOLEAN, "BooleanProperty");

// Proxies for the controller 4 on and off buttons
// Protocols are automatically decoded provided they are supported by RCSwitch
// Look in Protocols.h for the protocol table
// If you run this example you will see any supported device code printed in the serial monitor 
// together with its characteristics
...
// Light WebThings
ThingDevice Light1(&adapter, "Light 1", "IoT-Bus 433Mhz Light 1", sensorTypes);
ThingProperty light1(&Light1, "light", "433Mhz Light 1", BOOLEAN, "BooleanProperty");
ThingDevice Light2(&adapter, "Light 2", "IoT-Bus 433Mhz Light 2", sensorTypes);
ThingProperty light2(&Light2, "light", "433Mhz Light 2", BOOLEAN, "BooleanProperty");
ThingDevice Light3(&adapter, "Light 3", "IoT-Bus 433Mhz Light 3", sensorTypes);
ThingProperty light3(&Light3, "light", "433Mhz Light 3", BOOLEAN, "BooleanProperty");
ThingDevice Light4(&adapter, "Light 4", "IoT-Bus 433Mhz Light 4", sensorTypes);
ThingProperty light4(&Light4, "light", "433Mhz Light 3", BOOLEAN, "BooleanProperty");
...
ThingDevice outletController(&adapter, "OutletController", "IoT-Bus 433Mhz Outlet Controller", sensorTypes);
ThingProperty switch1(&outletController, "Control 1", "433Mhz Outlet Control 1", BOOLEAN, "BooleanProperty");
ThingProperty switch2(&outletController, "Control 2", "433Mhz Outlet Control 2", BOOLEAN, "BooleanProperty");
ThingProperty switch3(&outletController, "Control 3", "433Mhz Outlet Control 3", BOOLEAN, "BooleanProperty");
...
ThingDevice outlet1(&adapter, "Outlet 1", "IoT-Bus 433Mhz Outlet 1", sensorTypes);
ThingProperty power1(&outlet1, "Power", "433Mhz Outlet 1", BOOLEAN, "BooleanProperty");
ThingDevice outlet2(&adapter, "Outlet 2", "IoT-Bus 433Mhz Outlet 2", sensorTypes);
ThingProperty power2(&outlet2, "Power", "433Mhz Outlet 2", BOOLEAN, "BooleanProperty");
ThingDevice outlet3(&adapter, "Outlet 3", "IoT-Bus 433Mhz Outlet 3", sensorTypes);
ThingProperty power3(&outlet3, "Power", "433Mhz Outlet 3", BOOLEAN, "BooleanProperty");
